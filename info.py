...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5274915656 5926160191').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002158187278')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002082665507')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'PrimeBotz')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/JR1ZKMsb/photo-2025-03-07-13-18-00-7479265068685721608.jpg')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MHBDOFFICIALS') # Support Chat Link Without https:// or @
